...
def get_dataloader_from_image_filepath(
    ...
    if is_train is not True:  # eval mode
        ...
        images_loader = util_data.DataLoader(images, batch_size=batch_size, shuffle=True,
                                             num_workers=1)
...
class DataLoaderManager:
    ...
    def __init__(self, args):
        ...
        self.test_target_loader, self.test_target_sampler = get_dataloader_from_image_filepath(
            args.tgt_test_address, args, batch_size=args.batch_size, is_train=False, is_source=False)
